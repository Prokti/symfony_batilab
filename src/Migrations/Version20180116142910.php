 ...
 */
class Version20180116142910 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE house_product DROP FOREIGN KEY FK_479D82B05A2B7480');
        $this->addSql('DROP INDEX IDX_479D82B05A2B7480 ON house_product');
        $this->addSql('ALTER TABLE house_product CHANGE produt_id product_id INT NOT NULL');
        $this->addSql('ALTER TABLE house_product ADD CONSTRAINT FK_479D82B04584665A FOREIGN KEY (product_id) REFERENCES product (id)');
        $this->addSql('CREATE INDEX IDX_479D82B04584665A ON house_product (product_id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE house CHANGE long_ext long_ext DOUBLE PRECISION DEFAULT \'NULL\', CHANGE larg_ext larg_ext DOUBLE PRECISION DEFAULT \'NULL\', CHANGE surface_hab surface_hab DOUBLE PRECISION DEFAULT \'NULL\', CHANGE surface_annexe surface_annexe DOUBLE PRECISION DEFAULT \'NULL\', CHANGE nbr_chambre nbr_chambre INT DEFAULT NULL, CHANGE nbr_sdb nbr_sdb INT DEFAULT NULL');
        $this->addSql('ALTER TABLE house_product DROP FOREIGN KEY FK_479D82B04584665A');
        $this->addSql('DROP INDEX IDX_479D82B04584665A ON house_product');
        $this->addSql('ALTER TABLE house_product CHANGE product_id produt_id INT NOT NULL');
        $this->addSql('ALTER TABLE house_product ADD CONSTRAINT FK_479D82B05A2B7480 FOREIGN KEY (produt_id) REFERENCES product (id)');
        $this->addSql('CREATE INDEX IDX_479D82B05A2B7480 ON house_product (produt_id)');
        $this->addSql('ALTER TABLE product CHANGE category_id category_id INT DEFAULT NULL');
    }
}
